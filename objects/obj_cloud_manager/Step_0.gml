...
var num_clouds = instance_number(obj_small_cloud)
...
if (frames_since_cloud > frames_bt_cloud || num_clouds < 4) {
	...
	if(num_clouds < max_clouds) {
		...
		random_range(100, room_height - 100), "Instances",obj_small_cloud)
		...
		with(new_cloud) {
			...
			while(tries < 12000 && collision_rectangle(x-12, y-12, x+12, y+12, obj_small_cloud, 
				false, true) != noone) {
